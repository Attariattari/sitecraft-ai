...
export async function GET(req) {
    ...
    try {
        ...
        if (!user) {
            // Check if this is the root super admin
            ...
            user = new User({
                ...
                primaryPurpose: '', // Will be set in onboarding
                selectedPurposes: [],
                accountPurpose: '',
            });
            await user.save();
        } else {
            // Existing user - linking check
            if (user.authProvider === 'credentials' && !user.googleId) {
