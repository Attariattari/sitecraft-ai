          ...
          {siteCraftPersonalInfoCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className="group relative text-left bg-card border border-border rounded-2xl overflow-hidden hover:border-emerald-500/60 hover:shadow-lg hover:shadow-emerald-500/8 transition-all duration-200 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
              >
                {/* Top accent line */}
                <div className="h-[3px] w-full bg-gradient-to-r from-transparent via-emerald-500 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                <div className="p-5">
                  {/* Icon + Badge */}
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/15 flex items-center justify-center group-hover:bg-emerald-500/20 group-hover:border-emerald-500/30 transition-all duration-200">
                  ...
                  {/* Name */}
                  <h3 className="text-[15px] font-bold text-foreground mb-1 group-hover:text-emerald-600 transition-colors duration-200">
                    {cat.label}
                  </h3>

                  {/* Purpose pill */}
                  <span className="inline-block text-[11px] font-semibold text-muted-foreground/80 bg-muted border border-border px-2 py-0.5 rounded-md mb-3">
                    {cat.purpose}
                  </span>

                  {/* Description */}
                  <p className="text-[13px] text-muted-foreground leading-relaxed line-clamp-2 min-h-[38px]">
                    {cat.description}
                  </p>
                  ...
                  <div className="mt-4 pt-3.5 border-t border-border/60 flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 text-[12px] font-semibold text-emerald-600 bg-emerald-500/10 px-2.5 py-1 rounded-lg opacity-0 group-hover:opacity-100 translate-x-1 group-hover:translate-x-0 transition-all duration-200">
                      Select
