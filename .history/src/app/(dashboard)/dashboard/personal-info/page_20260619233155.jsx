    ...
    async function init() {
      try {
        ...
        const catRes = await fetch(
          "/api/categories/available?context=dashboard",
        );
          ...
          <div className="bg-card border border-border rounded-2xl p-2 sticky top-6">
            <div className="flex flex-col gap-1">
              ...
              {selectedPurposes.map((pid) => {
                ...
                const dbCat = categories.find((c) => c.slug === pid);
                const IsActive = activeTab === pid;
                const IsDisabled = dbCat && !dbCat.isSelectable;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="ml-auto flex items-center gap-2">
                      {IsDisabled && (
                        <div className="bg-orange-500/10 text-orange-500 px-1.5 py-0.5 rounded text-[7px] font-black uppercase tracking-tighter border border-orange-500/20 flex items-center gap-1">
