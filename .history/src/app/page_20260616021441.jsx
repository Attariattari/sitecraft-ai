    ...
    <div className="flex flex-col min-h-screen font-sans selection:bg-[var(--template-primary)]/20 text-[var(--template-foreground)]">
      ...
      <header className="w-full z-50 bg-[var(--template-background)]/80 backdrop-blur-md border-b border-[var(--template-border)] transition-all duration-300">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--template-muted)]">
            <a
              href="#"
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-20 lg:py-32 overflow-hidden bg-[var(--template-soft)]">
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-[var(--template-muted)] mb-12 max-w-2xl mx-auto leading-relaxed">
        ...
        <section className="py-24 bg-[var(--template-background)]">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-[var(--template-muted)] max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-start gap-4 p-8 rounded-2xl bg-[var(--template-soft)] border border-[var(--template-border)] group hover:border-[var(--template-primary)]/30 transition-all shadow-sm hover:shadow-md">
                ...
                <p className="text-[var(--template-muted)] leading-relaxed">
                  Optimized for speed and performance, ensuring your users never
                  have to wait.
                </p>
              </div>
              <div className="flex flex-col items-start gap-4 p-8 rounded-2xl bg-[var(--template-soft)] border border-[var(--template-border)] group hover:border-[var(--template-accent)]/30 transition-all shadow-sm hover:shadow-md">
        ...
        <section className="py-24 bg-[var(--template-soft)] relative">
          <div className="container mx-auto px-6">
      ...
      <footer className="bg-[var(--template-background)] border-t border-[var(--template-border)] py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-[var(--template-muted)] text-sm">
            © 2026 Brand Name. All rights reserved.
          </p>
          <div className="flex gap-6 text-sm text-[var(--template-muted)]">
            <a
              href="#"
              className="hover:text-[var(--template-primary)] transition-colors"
            >
