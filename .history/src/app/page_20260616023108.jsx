      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 lg:py-32 overflow-hidden bg-[var(--template-soft-background)]">
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button
                  size="lg"
                  className="h-14 px-8 text-lg font-semibold w-full sm:w-auto shadow-lg shadow-[var(--template-primary)]/20 dark:shadow-[var(--template-primary)]/40"
                >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none -z-10">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[var(--template-primary)] rounded-full blur-[100px] opacity-[0.05] dark:opacity-[0.15]" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[var(--template-accent)] rounded-full blur-[100px] opacity-[0.05] dark:opacity-[0.15]" />
          </div>
        </section>
        ...
        <section className="py-24 bg-[var(--template-background)]">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-start gap-4 p-8 rounded-2xl bg-[var(--template-soft-background)] border border-[var(--template-border)] group hover:border-[var(--template-primary)]/50 transition-all shadow-sm hover:shadow-md dark:shadow-none dark:hover:shadow-[0_0_30px_-5px_var(--template-primary)] relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--template-primary)] to-transparent opacity-0 group-hover:opacity-[0.03] dark:group-hover:opacity-[0.1] transition-opacity pointer-events-none" />
                <div className="size-12 bg-[var(--template-primary)]/10 rounded-xl flex items-center justify-center text-[var(--template-primary)] group-hover:scale-110 transition-transform relative z-10">
                  <Zap className="size-6" />
                </div>
                <h3 className="text-xl font-bold text-[var(--template-foreground)] relative z-10">
                  Lightning Fast
                </h3>
                <p className="text-[var(--template-muted-foreground)] leading-relaxed relative z-10">
                  Optimized for speed and performance, ensuring your users never
                  have to wait.
                </p>
              </div>
              <div className="flex flex-col items-start gap-4 p-8 rounded-2xl bg-[var(--template-soft-background)] border border-[var(--template-border)] group hover:border-[var(--template-accent)]/50 transition-all shadow-sm hover:shadow-md dark:shadow-none dark:hover:shadow-[0_0_30px_-5px_var(--template-accent)] relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--template-accent)] to-transparent opacity-0 group-hover:opacity-[0.03] dark:group-hover:opacity-[0.1] transition-opacity pointer-events-none" />
                <div className="size-12 bg-[var(--template-accent)]/10 rounded-xl flex items-center justify-center text-[var(--template-accent)] group-hover:scale-110 transition-transform relative z-10">
        ...
        <section className="py-24 bg-[var(--template-soft-background)] relative">
          <div className="container mx-auto px-6">
            <div className="bg-[var(--template-foreground)] text-[var(--template-background)] rounded-3xl p-12 lg:p-20 relative overflow-hidden flex flex-col items-center text-center">
              <div className="absolute inset-0 bg-gradient-to-br from-[var(--template-primary)] to-transparent opacity-[0.2] dark:opacity-[0.35] pointer-events-none" />
              ...
              <div className="relative z-10">
                <Button
                  variant="accent"
                  size="lg"
                  className="h-14 px-10 text-lg font-bold shadow-xl shadow-[var(--template-accent)]/20 dark:shadow-[var(--template-accent)]/40"
                >
