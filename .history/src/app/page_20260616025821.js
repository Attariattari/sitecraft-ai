...
import { ArrowRight, Sparkles, Layout, Zap, Shield } from "lucide-center";
import { LucideIcon } from "lucide-react"; // I'll use standard lucide-react if lucide-center was a typo or something

// Fixed imports to use lucide-react which is in package.json
import {
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-secondary-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
                SiteCraft AI combines the power of generative design with a
                professional - grade editor.Effortlessly launch premium, high -
                converting websites.{" "}
              </p>{" "}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  Start Building Free <ArrowRightIcon className="ml-2 size-5" />
                </Button>{" "}
                <Button
                  variant="outline"
                  size="lg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="flex flex-col items-start gap-4 p-6 rounded-2xl bg-soft border border-border group hover:border-primary/30 transition-all shadow-sm hover:shadow-md">
                ...
                <p className="text-secondary-foreground leading-relaxed">
                  Generate complete landing pages with copy and optimized images
                  in under 30 seconds.{" "}
                </p>{" "}
              </div>{" "}
              <div className="flex flex-col items-start gap-4 p-6 rounded-2xl bg-soft border border-border group hover:border-primary/30 transition-all shadow-sm hover:shadow-md">
                ...
                <p className="text-secondary-foreground leading-relaxed">
                  Clean, responsive layouts that follow modern SaaS design
              ...
              <div className="flex flex-col items-start gap-4 p-6 rounded-2xl bg-soft border border-border group hover:border-primary/30 transition-all shadow-sm hover:shadow-md">
                ...
                <p className="text-secondary-foreground leading-relaxed">
                  Built with performance, SEO, and security in mind.Hosted on
          ...
          <div className="container mx-auto px-6">
            <div className="bg-foreground text-background rounded-3xl p-12 lg:p-20 relative overflow-hidden flex flex-col items-center text-center">
              ...
              <p className="text-lg text-secondary mb-10 max-w-xl relative z-10 opacity-80">
                Join 10, 000 + creators building the future of the web with
                SiteCraft AI.{" "}
              </p>{" "}
