      ...
      {!collapsed && user && (
        <div className="px-4 py-3 border-b border-border bg-primary/5">
          <div className="flex items-center justify-between">
            ...
            <span className="site-badge-emerald text-[10px] py-0.5 px-1.5 font-black uppercase tracking-widest leading-none">
              Pro
            </span>
          </div>
...
export function DashboardSidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-64 shrink-0 border-r border-border bg-card/50 backdrop-blur-md h-screen sticky top-0 flex-col text-left">
        <SidebarContent />
      </aside>
