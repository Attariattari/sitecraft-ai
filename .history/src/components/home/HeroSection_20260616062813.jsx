          ...
          <div className="relative rounded-2xl border border-border bg-card shadow-2xl shadow-black/10 overflow-hidden">
            ...
            <div className="bg-soft p-6 md:p-10 min-h-[280px] flex flex-col gap-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="h-3 w-32 bg-foreground/10 rounded-full mb-1.5" />
                  <div className="h-2.5 w-48 bg-foreground/6 rounded-full" />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                {[1, 2, 3].map((n) => (
                  ...
                  >
                    <div className="h-20 rounded-lg bg-primary/8 mb-1" />
                    <div className="h-2.5 w-3/4 bg-foreground/10 rounded-full" />
                    <div className="h-2 w-1/2 bg-foreground/6 rounded-full" />
                  </div>
                ))}
              </div>
              <div className="flex items-center gap-3">
                <div className="h-9 w-36 rounded-xl bg-primary/20 animate-pulse" />
                <div className="h-9 w-24 rounded-xl bg-foreground/8" />
              </div>
            </div>
          </div>
        </motion.div>
