export function CategoriesSection() {
  ...
  const activeCategory = categories.find(c => c.isAvailable && !c.isLocked) || categories[0];
  const comingSoon = categories.filter(c => c.isLocked || !c.isAvailable);
          ...
          {comingSoon.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-sm font-bold text-foreground mb-1 group-hover:text-orange-500 transition-colors">
                  {item.title}
                </h4>
