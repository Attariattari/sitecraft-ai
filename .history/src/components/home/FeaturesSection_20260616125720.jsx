...
export function FeaturesSection() {
  return (
    <section className="py-28 bg-transparent relative" id="features">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold border border-primary/20 mb-5 backdrop-blur-sm">
            Platform Features
          </span>
          ...
          {features.map((feature, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative flex flex-col gap-5 p-8 rounded-[2.5rem] glass-card overflow-hidden cursor-default
                  ${feature.span}`}
              >
                {/* Hover glow */}
                <div
