  ...
  return (
    <section className="py-28 bg-background" id="how-it-works">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-accent/10 text-accent text-sm font-semibold border border-accent/20 mb-5">
            How It Works
          </span>
            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content card */}
                  <div
                    className={`flex-1 ${isEven ? "md:pr-[calc(50%+3rem)]" : "md:pl-[calc(50%+3rem)]"}`}
                  >
                    <div className="group relative bg-soft border border-border rounded-3xl p-8 hover:border-primary/30 hover:shadow-lg transition-all duration-300 overflow-hidden">
