      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-foreground tracking-tight mb-5">
            Everything you need,{" "}
            <span className="site-gradient-text font-black">
              nothing you don't
            </span>
          </h2>
          ...
          {features.map((feature, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative flex flex-col gap-5 p-10 rounded-[2.5rem] site-glass-card overflow-hidden cursor-default
                  ${feature.span}`}
              >
                {/* Hover glow */}
                <div
