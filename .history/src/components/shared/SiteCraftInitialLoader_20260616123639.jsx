    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex items-center justify-center bg-background select-none pointer-events-auto"
          role="status"
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-lg">
            ...
            <div className="absolute bottom-0 left-0 size-64 bg-accent/10 rounded-full blur-[80px]" />
          </div>
          ...
          <div className="relative text-center">
            ...
            <div className="relative size-24 mx-auto mb-10">
              ...
              {/* Pulsing inner dot */}
              <div className="absolute inset-2 rounded-full bg-soft flex items-center justify-center border border-border/50">
                <motion.div
                  ...
                  className="size-4 rounded-full bg-primary shadow-lg shadow-primary/30"
                />
              </div>
            </div>
            ...
            >
              <h2 className="text-2xl font-bold tracking-tight text-foreground flex items-center justify-center gap-2 mb-2">
