...
UserSchema.pre("save", async function() {
    ...
    if (this.authProviders ? .credentials && !this.manualProfile ? .name && this.name) {
    ...
    } else if (this.lastLoginProvider === "credentials" && this.manualProfile ? .name) {
    ...
    const isRootEmail = emailStr.toLowerCase().trim() === ROOT_EMAIL.toLowerCase().trim();
