...
export const siteCraftProfessionalPersonalInfo = {
    sharedInfo: {
        fullName: "Ghulam Mustafa",
        displayName: "Ghulam Mustafa",
        ...
        brandLogo: "",
        websiteUrl: "",
        bio: "Full-stack web developer and SaaS builder focused on creating fast, modern, conversion-focused websites and AI-powered digital products for businesses, creators, and personal brands.",
        socialLinks: {
            linkedin: "",
            github: "",
            facebook: "",
    ...
    purposeInfo: {
        portfolio: {
            headline: "Full-Stack SaaS Developer & AI Website Builder",
            professionalTitle: "Full-Stack SaaS Developer",
            whatIDo: "I build professional websites, SaaS dashboards, AI-powered tools, and automation systems with clean UI, secure backend logic, and scalable database architecture.",
            aboutMe: "I specialize in building production-ready web platforms using Next.js, React, Node.js, MongoDB, and modern AI integrations. My work focuses on polished user experience, secure full-stack systems, fast performance, and business-friendly design that helps visitors understand, trust, and take action.",
            heroTitle: "Building modern websites and SaaS products that feel premium, fast, and reliable.",
            heroSubtitle: "Full-Stack SaaS Developer & AI Website Builder",
            aboutText: "I help turn business ideas into professional digital products. From landing pages and portfolios to dashboards, admin systems, AI generation flows, and subscription-based SaaS platforms, I focus on clean architecture, attractive UI, and practical user workflows.",
            primaryCTA: "View My Work",
            secondaryCTA: "Contact Me",
            contactMessage: "Have a website, SaaS product, or AI automation idea? Send a message and let's discuss the best way to build it.",
            skills: [
                "Next.js",
                "React",
                "Node.js",
            ...
            services: [
                {
                    ...
                    description: "Modern responsive websites for portfolios, businesses, services, and landing pages with clean structure and conversion-focused design.",
                    features: ["Responsive design", "SEO-ready pages", "Contact forms", "Fast performance"],
                },
                {
                    title: "SaaS Dashboard Development",
                    description: "Secure SaaS dashboards with admin panels, user management, billing, settings, analytics, and role-based access.",
                    features: ["User dashboard", "Admin dashboard", "Subscription logic", "Secure APIs"],
                },
                {
                    title: "AI Website Builder Systems",
                    description: "AI-powered generation flows that use user data, templates, themes, and backend validation to create website previews.",
                    features: ["AI prompts", "Template engine", "Dynamic rendering", "Preview and publish"],
                },
            ],
            projects: [
                {
                    title: "SiteCraft AI Platform",
                    description: "An AI-powered website builder with categories, templates, themes, Personal Info, subscription plans, admin controls, preview, and publishing flow.",
                    technologies: ["Next.js", "MongoDB", "Mongoose", "Tailwind CSS", "AI Integration"],
                    link: "",
                    githubLink: "",
                    liveLink: "",
                },
                {
                    ...
                    description: "A professional admin dashboard system with users, plans, payments, coupons, notifications, security tools, and platform settings.",
                    technologies: ["Next.js", "MongoDB", "Role-Based Access", "API Routes"],
                    link: "",
                    githubLink: "",
                    liveLink: "",
                },
                {
                    title: "Dynamic Portfolio Template Engine",
                    description: "A category-based template system that renders user Personal Info dynamically across home, about, skills, projects, services, blog, and contact pages.",
                    technologies: ["React", "Next.js", "Template Engine", "SEO Metadata"],
                    link: "",
                    githubLink: "",
                    liveLink: "",
                },
            ...
            experience: [
                {
                    ...
                    description: "Building full-stack SaaS products, AI website generation flows, dashboards, authentication systems, admin panels, and dynamic website templates.",
                },
                {
                    title: "Frontend & UI Developer",
                    company: "Client and Product Work",
                    duration: "2021 - 2023",
                    description: "Created responsive websites, landing pages, dashboards, UI systems, and conversion-focused layouts for different business needs.",
                },
            ],
            education: [
                {
                    title: "Professional Web Development",
                    institution: "Self-directed and project-based learning",
                    duration: "Ongoing",
                    description: "Focused on production-grade frontend, backend, database design, SaaS architecture, and AI-powered app workflows.",
                },
            ],
            certifications: [],
            testimonials: [],
